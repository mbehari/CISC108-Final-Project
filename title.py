...
instructions3 = text("black", "Choose which note/signature the image represents and increase your score!", 20, 400, 400)
draw(instructions, instructions2, instructions3, game_name)
